...
// let total=0;
// function updateTotal(price){
//     // total değer ve girilrn değeri toplama
//     total+=Number(price);
//     // console.log(price)
//     totalInfo.textContent=total;
//     // console.log(total)
...
// function addExpense(e){
//     e.preventDefault()
//     // eski kullanım priceınput===""
//     if(!priceInput.value || !spendingInput.value){
//         alert("Boş gider eklenemez")
//         // fonksiyonu durdurmak için
//         return;
//     }
//     // 1- kullanıcı veri girdiğinde ve ekle deiğinde div oluştur
...
//         // kapsayıcsının kapsayıcısına parentElement dir
//         const wrapper=element.parentElement.parentElement
...
//         //silinenin fiyatını toplamdan çıkar
//         //updateTotalı güncelleme
//         updateTotal(- Number(deletedPrice))
...
//     // ! childNodes
//     // childNodes  : parentElementin tersine kapsayıcıya 
